...
* [Tomato](userspace/libraries/libc/): the standard C library
* [Tarwi](https://github.com/wither16x/tarwi): a unit test library in C++
* [Melon](userspace/libraries/melon/): the main library for writing C++ user programs
* [CASH](userspace/cash): the shell
