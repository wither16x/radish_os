...
* [Melon](https://github.com/wither16x/melon): the main library for writing C++ user programs
* [CASH](https://github.com/wither16x/cash): the shell
...
Note that building the system from scratch can be really hard. The build process is going to be greatly improved (trust). Please prefer downloading an ISO from the latest release.
...
* [CASH](https://github.com/wither16x/cash)
